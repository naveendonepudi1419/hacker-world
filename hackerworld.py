# _   _    _    ____ _  _______ ____   __        _____  ____  _     ____  
#| | | |  / \  / ___| |/ / ____|  _ \  \ \      / / _ \|  _ \| |   |  _ \ 
#| |_| | / _ \| |   | ' /|  _| | |_) |  \ \ /\ / / | | | |_) | |   | | | |
#|  _  |/ ___ \ |___| . \| |___|  _ <    \ V  V /| |_| |  _ <| |___| |_| |
#|_| |_/_/   \_\____|_|\_\_____|_| \_\    \_/\_/  \___/|_| \_\_____|____/ 
#
#                                                                                      
#
#                              ~ Tools For Hacking by D.Naveen
...
def logo():
    print """
                           - Powered by
    _   __                               ____                                   ___ 
   / | / /___ __   _____  ___  ____     / __ \____  ____  ___  ____  __  ______/ (_)
  /  |/ / __ `/ | / / _ \/ _ \/ __ \   / / / / __ \/ __ \/ _ \/ __ \/ / / / __  / / 
 / /|  / /_/ /| |/ /  __/  __/ / / /  / /_/ / /_/ / / / /  __/ /_/ / /_/ / /_/ / /  
/_/ |_/\__,_/ |___/\___/\___/_/ /_/  /_____/\____/_/ /_/\___/ .___/\__,_/\__,_/_/   
                                                           /_/                       
"""


hackerworldlogo = """\033[0m
 _   _    _    ____ _  _______ ____   __        _____  ____  _     ____  
| | | |  / \  / ___| |/ / ____|  _ \  \ \      / / _ \|  _ \| |   |  _ \ 
| |_| | / _ \| |   | ' /|  _| | |_) |  \ \ /\ / / | | | |_) | |   | | | |
|  _  |/ ___ \ |___| . \| |___|  _ <    \ V  V /| |_| |  _ <| |___| |_| |
|_| |_/_/   \_\____|_|\_\_____|_| \_\    \_/\_/  \___/|_| \_\_____|____/ 
                                                  ...
                                                  ~~Tools For Hacking by Naveen Donepudi
                                                                             

 \033[91m"""
def menu():
    print (hackerworldlogo + """\033[1m
...
\033[0m
   ...
   {8}--Post Exploitation
   {0}--Install The hackerworld
   {99}-Exit
 """)
    choice = raw_input("hackerworld~# ")
    os.system('clear')
    if choice == "1":
        info()
    elif choice == "2":
...
def updatehackerworld():
    print ("This Tool is Only Available for Linux Systems. ")
    choiceupdate = raw_input("Continue Y / N: ")
    if choiceupdate in yes:
        os.system("git clone https://github.com/naveendonepudi1419/hacker-world.git")
        os.system("cd hackerworld && sudo bash ./update.sh")
        os.system("hackerworld")
...
def webhack():
    ...
    choiceweb = raw_input("hackerworld~# ")
    if choiceweb == "1":
        clearScr()
        maine()
    if choiceweb == "2":
...
def fluxion():
    ...
    choice = raw_input("Continue ? Y / N : ")
    if choice in yes:
        os.system("git clone https://github.com/naveendonepudi1419/Fluxion.git") 
